...
public class DatabaseAdapterParlacen {
    ...
    private static final String ELECTRONIC_ELECTION_CONCEPTS_COUNT_VOTES = "concepts_count_electronic";
    private static final String MANUAL_ELECTION_CONCEPTS_COUNT_VOTES = "concepts_count_manual";
...
//                conceptsValues.put("PREFERENTIAL ELECTION ID", cursor.getString(1));
    ...
    public void updateElectronicConceptsCount(LinkedHashMap<String,String> escrutadaMap, String jrv){
        if(Consts.LOCALE.contains("ELSA")){
            updateElectronicConceptCountSV(escrutadaMap,jrv);
        }else
            updateConceptCountHN(escrutadaMap,jrv);
    }

    private void updateElectronicConceptCountSV(LinkedHashMap<String,String> escrudataMap,String jrv){
        Log.e("DATABASEADAPTER: ", escrudataMap.toString());
        ContentValues contentValues = new ContentValues();
        ...
        contentValues.put("Entregadas",
                escrudataMap.get("ENTREGADAS"));
        int rows = database.update(ELECTRONIC_ELECTION_CONCEPTS_COUNT_VOTES,contentValues, "JRV= '"+jrv+"'", null);
        Log.e("CROSSUPDATE","rows updated: "+String.valueOf(rows)+" of JRV = "+jrv);
    }

    public void updateManualConceptsCount(LinkedHashMap<String,String> escrutadaMap, String jrv){
        if(Consts.LOCALE.contains("ELSA")){
            updateManualConceptCountSV(escrutadaMap,jrv);
        }else
            updateConceptCountHN(escrutadaMap,jrv);
    }

    private void updateManualConceptCountSV(LinkedHashMap<String,String> escrudataMap,String jrv){
        Log.e("DATABASEADAPTER: ", escrudataMap.toString());
        ContentValues contentValues = new ContentValues();
        ...
        contentValues.put("Entregadas",
                escrudataMap.get("ENTREGADAS"));
        int rows = database.update(MANUAL_ELECTION_CONCEPTS_COUNT_VOTES,contentValues, "JRV= '"+jrv+"'", null);
        Log.e("CROSSUPDATE","rows updated: "+String.valueOf(rows)+" of JRV = "+jrv);
    }
...
//        String query = "INSERT INTO logTableELSA ("+logIndex+","+Dui_1+","+Dui_2+","+time_stamp+")"+" VALUES (logIndex, Dui_1, Dui_2, Time_stamp)";
    ...
    public void logDui1(String logIndex, String Dui_1, String time_stamp){
        ...
        String query = "INSERT INTO logTableELSA (logIndex, Dui_1, Dui_2, Dui_3, Dui_4, Dui_5, Time_stamp) VALUES ('"+logIndex+"','"+Dui_1+"','"+" "+"','"+" "+"','"+" "+"','"+" "+"','"+time_stamp+"'"+")";
