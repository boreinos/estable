...
import com.afilon.mayor.v11.model.PartySummaryReport;
...
public class SummaryActivityPreferential extends FragmentActivity {
    ...
    private boolean isActaReport = true;
    ...
    private PartySummaryReport partySummaryReport =
            new PartySummaryReport("", "", "", "", "", "",
    ...
    public void doPrint(View view) {
        ...
        if(isActaReport) {
            printManager.print(jobName, new PrintAdapter(this, Consts.LOCALE, actaSumaryReport, true),
                    null); //
        } else {
            printManager.print(jobName, new PrintAdapter(this, Consts.LOCALE, partySummaryReport, false),
                    null); //
        }
...
//            applog = b.getParcelable("com.afilon.mayor.applog");
        ...
        partySummaryReport.setTitleB(votecenter_tv.getText().toString());
        partySummaryReport.setTitleC("Departamento: " + departmental_tv.getText().toString() + "       JRV: " + jrv_tv.getText().toString());
...
//        }
    ...
    public void loadSummaryParty(int ID) {
        ...
        //CARLOS:
        partySummaryReport.setPartyName(party.getParty_name().toUpperCase());
...
//            entries.get(i).setPlanchaVotes();
            ...
            //CARLOS:
            Log.e("=== entries Party Votes", "true");
            Log.e("Party Name",      party.getParty_name().toUpperCase());
            Log.e("candidateName",    candidates.get(i).getCandidate_name());
            Log.e("setPlanchaMarcas", entries.get(i).getPlanchaMarcas());
            Log.e("setParcialMarcas", entries.get(i).getParcialMarcas());
            Log.e("setCruzadoMarcas", entries.get(i).getCruzadoMarcas());
            Log.e("setPlanchaVotes",  entries.get(i).getPlanchaVotes());
            Log.e("setParcialVotes",  entries.get(i).getParcialVotes());
            Log.e("setCruzadoVotes",  entries.get(i).getCruzadoVotes());
            Log.e("setTotalVotes",    entries.get(i).getTotalVotes());
            Log.e("===", "true");

            columnA.add( candidates.get(i).getCandidate_name() );
            columnB.add( entries.get(i).getPlanchaMarcas() );
            columnC.add( entries.get(i).getParcialMarcas() );
            columnD.add( entries.get(i).getCruzadoMarcas() );
            columnE.add( entries.get(i).getPlanchaVotes() );
            columnF.add( entries.get(i).getParcialVotes() );
            columnG.add( entries.get(i).getCruzadoVotes() );
            columnH.add( entries.get(i).getTotalVotes() );


        }

        //CARLOS:
        partySummaryReport.setColumnA(columnA);
        partySummaryReport.setColumnB(columnB);
        partySummaryReport.setColumnC(columnC);
        partySummaryReport.setColumnD(columnD);
        partySummaryReport.setColumnE(columnE);
        partySummaryReport.setColumnF(columnF);
        partySummaryReport.setColumnG(columnG);
        partySummaryReport.setColumnH(columnH);
...
//    public class PrintAdapter extends PrintDocumentAdapter {
    public class PrintAdapter extends PrintServiceXP {
        ...
        private PartySummaryReport psr;
        private boolean isActa = false;
        ...
        public PrintAdapter(Context context, Object key, Object value, boolean isActa) {
            ...
            if(isActa) {
                ...
                this.psr = (PartySummaryReport) value;
        ...
        private void drawPage(PdfDocument.Page page,
            ...
            if(isActa) { //IT's AN ACTA REPORT
            ...
            } else { //IT'S A PARTY REPORT
                paint.setTextSize(14);
                canvas.drawText(this.psr.getTitleB(), leftMargin, titleBaseLine + 35, paint);
                canvas.drawText("PARTIDO :" + this.psr.getPartyName().toString(), leftMargin, titleBaseLine + 55, paint);
                canvas.drawText(datet, leftMargin + 200, titleBaseLine + 55, paint);
                ...
                paint.setColor(Color.BLACK);
                paint.setTextSize(9);
                canvas.drawText("CANDIDATO          TOTAL          BANDERA   BANDERA          PREFERENCIAL",
                        leftMargin, titleBaseLine + (75), paint);
                canvas.drawText("               VOTOS/MARCAS       VOTOS     VOTOS/MARCAS     VOTOS/MARCAS",
                        leftMargin, titleBaseLine + (95), paint);
                canvas.drawText("======================================================================================",
                ...
                int icounter = 120;
                int imargin = 200;
                for (int c = 0; c < this.psr.getColumnA().size(); c++) {
                    canvas.drawText(this.psr.getColumnA().get(c).toString(), leftMargin, titleBaseLine + (icounter), paint);

                    canvas.drawText(this.psr.getColumnH().get(c).toString(), leftMargin + imargin, titleBaseLine + (icounter), paint);

                    int iColumnCD = Integer.parseInt(this.psr.getColumnC().get(c).toString()) + Integer.parseInt(this.psr.getColumnD().get(c).toString());
                    canvas.drawText(String.valueOf(iColumnCD), leftMargin + imargin + 50, titleBaseLine + (icounter), paint);

//                    canvas.drawText(this.psr.getColumnD().get(c).toString(), leftMargin + imargin + 50, titleBaseLine + (icounter), paint);
                    canvas.drawText(this.psr.getColumnB().get(c).toString(), leftMargin + imargin + 100, titleBaseLine + (icounter), paint);
                    canvas.drawText(this.psr.getColumnB().get(c).toString(), leftMargin + imargin + 150, titleBaseLine + (icounter), paint);
                    canvas.drawText(this.psr.getColumnC().get(c).toString(), leftMargin + imargin + 200, titleBaseLine + (icounter), paint);
                    canvas.drawText(this.psr.getColumnG().get(c).toString(), leftMargin + imargin + 250, titleBaseLine + (icounter), paint);
                    canvas.drawText(this.psr.getColumnD().get(c).toString(), leftMargin + imargin + 300, titleBaseLine + (icounter), paint);
                    icounter += 20;
                    //imargin += 50;
                }
